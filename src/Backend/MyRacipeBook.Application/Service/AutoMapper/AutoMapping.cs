...
public class AutoMapping : Profile
{
    ...
    private void DomaimToResponse()
    {
        ...
        CreateMap<MyRecipebook.Domain.Entities.Recipe, ResponseRecipeJson>()
        ...
        CreateMap<MyRecipebook.Domain.Entities.Ingredient, ResponseIngredientJson>()
            .ForMember(dest => dest.Id, opt => opt.MapFrom(source => _idEncoder.Encode(source.Id)));

        CreateMap<MyRecipebook.Domain.Entities.Instruction, ResponseInstructionJson>()
            .ForMember(dest => dest.Id, opt => opt.MapFrom(source => _idEncoder.Encode(source.Id)));
    }
}
